...
public class GenerarEventoResponse {
    ...
    @XmlElementRef(name = "GenerarEventoResult", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<EventoResponse> generarEventoResult;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link EventoResponse }{@code >}
     *     
     */
    public JAXBElement<EventoResponse> getGenerarEventoResult() {
     ...
     *     
     */
    public void setGenerarEventoResult(JAXBElement<EventoResponse> value) {
