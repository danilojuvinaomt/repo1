 ...
 *         &lt;element name="documentoEvento" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlRootElement(name = "DescargarEventoXML", namespace = "http://tempuri.org/")
public class DescargarEventoXML {
    ...
    @XmlElementRef(name = "documentoEvento", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> documentoEvento;
    ...
    /**
     * Obtiene el valor de la propiedad documentoEvento.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getDocumentoEvento() {
        return documentoEvento;
    }

    /**
     * Define el valor de la propiedad documentoEvento.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setDocumentoEvento(JAXBElement<String> value) {
        this.documentoEvento = value;
    }
